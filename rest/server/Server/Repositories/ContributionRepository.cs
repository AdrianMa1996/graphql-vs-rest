...
namespace Server.Repositories
{
    public class ContributionRepository : IContributionRepository
    {
        ...
        public async Task<List<Contribution>> GetContributionsFilteredAsync(Guid? projectId, string? category, string? status)
        {
            var query = _dbConnection.Table<Contribution>();
